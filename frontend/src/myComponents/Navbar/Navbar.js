      ...
      {!token ?
        ...
        <AppBar position="fixed" className={classes.appBar} style={themestyle}>
          <Toolbar>
            ...
            {i > '/proddeets/'? i !== '/profile/' ? <><Button component={Link} to='/' variant="text" style={themestyle}>Home</Button> <Button component={Link} to='/categories/' variant="text" style={themestyle}>Categories</Button> <Button component={Link} to='/profile/' variant="text" style={themestyle}>Your Profile</Button></>: '': ''}
            <div className={classes.grow} />
